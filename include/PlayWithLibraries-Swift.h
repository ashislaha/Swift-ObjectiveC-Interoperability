...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PlayWithLibraries",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17PlayWithLibraries11AppDelegate")
...
SWIFT_CLASS("_TtC17PlayWithLibraries13SceneDelegate")
...
SWIFT_CLASS("_TtC17PlayWithLibraries14SwiftAppTarget")
@interface SwiftAppTarget : NSObject
- (void)test;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC17PlayWithLibraries14ViewController")
