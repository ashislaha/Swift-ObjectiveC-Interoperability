...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftStaticLibraryThree",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (NSInteger)subtractionWithA:(NSInteger)a b:(NSInteger)b SWIFT_WARN_UNUSED_RESULT;
